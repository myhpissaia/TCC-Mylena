                            ...
                            <form action="ServletCadastro" method="POST">
                                <div class="col-md-6">
                                    ...
                                    <div class="group">
                                        ...
                                        <span class="bar"></span>
                                        <label>
                                            <i class="material-icons glyphicon glyphicon-envelope <%= request.getAttribute("css-email") %>"></i>
                                            <span class="span-input <%= request.getAttribute("css-email") %>">E-mail</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="group">
                                        ...
                                        <label>
                                            ...
                                            <span class="span-input <%= request.getAttribute("css-senha") %>">Confirmar Senha</span>
                                        </label>
                                    </div>
                                    <div class="wrapper">
